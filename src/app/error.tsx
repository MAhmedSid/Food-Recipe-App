    ...
    <>
      <div className="flex flex-col justify-center items-center h-[70vh] gap-y-10 ">
        ...
        <div className="flex gap-x-5">
          <button onClick={() => router.push("/")} className="py-2 px-4 border-[1px] border-black rounded-md text-lg hover:bg-black hover:text-white hover:border-white transition-all">Home</button>
          <button
            onClick={() => reset()}
